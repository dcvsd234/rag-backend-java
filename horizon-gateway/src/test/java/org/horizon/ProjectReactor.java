...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "org.horizon";
    private static final String ARTIFACT_ID = "horizon";
    private static final String PACKAGE_NAME = "org.horizon";
    private static final String TITLE = "Horizon 管理システム";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "org.horizon";       // 建议用 org/com 这种规范
        String artifactIdNew = "horizon";        // 项目 ID，内部平台就用 horizon
        String packageNameNew = "org.horizon";   // Java 包名保持和 groupId 一致
        String titleNew = "Horizon Horizon 管理システム";  // 系统标题（日语场景友好）
