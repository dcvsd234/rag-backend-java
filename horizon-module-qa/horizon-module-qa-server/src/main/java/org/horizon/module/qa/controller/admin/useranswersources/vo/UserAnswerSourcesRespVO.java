...
@Schema(description = "管理后台 - RAG 回复来源表（记录答案所用的FAQ/文档/切片/AI等证据） Response VO")
@Data
@ExcelIgnoreUnannotated
public class UserAnswerSourcesRespVO {

    @Schema(description = "来源记录ID", requiredMode = Schema.RequiredMode.REQUIRED, example = "18637")
    @ExcelProperty("来源记录ID")
    private Long id;
