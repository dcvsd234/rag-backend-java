package org.horizon.module.bpm.service.task;
...
import org.horizon.framework.common.util.date.DateUtils;
import org.horizon.framework.common.util.number.NumberUtils;
import org.horizon.framework.common.util.object.ObjectUtils;
import org.horizon.framework.common.util.object.PageUtils;
import org.horizon.framework.datapermission.core.annotation.DataPermission;
import org.horizon.framework.web.core.util.WebFrameworkUtils;
import org.horizon.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import org.horizon.module.bpm.controller.admin.task.vo.task.*;
import org.horizon.module.bpm.convert.task.BpmTaskConvert;
import org.horizon.module.bpm.dal.dataobject.definition.BpmFormDO;
import org.horizon.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import org.horizon.module.bpm.enums.definition.*;
import org.horizon.module.bpm.enums.task.BpmCommentTypeEnum;
import org.horizon.module.bpm.enums.task.BpmReasonEnum;
import org.horizon.module.bpm.enums.task.BpmTaskSignTypeEnum;
import org.horizon.module.bpm.enums.task.BpmTaskStatusEnum;
import org.horizon.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import org.horizon.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import org.horizon.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
import org.horizon.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import org.horizon.module.bpm.framework.flowable.core.util.FlowableUtils;
import org.horizon.module.bpm.service.definition.BpmFormService;
import org.horizon.module.bpm.service.definition.BpmModelService;
import org.horizon.module.bpm.service.definition.BpmProcessDefinitionService;
import org.horizon.module.bpm.service.message.BpmMessageService;
import org.horizon.module.bpm.service.message.dto.BpmMessageSendWhenTaskTimeoutReqDTO;
...
import static org.horizon.framework.common.util.collection.CollectionUtils.*;
import static org.horizon.module.bpm.enums.ErrorCodeConstants.*;
import static org.horizon.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static org.horizon.module.bpm.framework.flowable.core.enums.BpmnVariableConstants.PROCESS_INSTANCE_VARIABLE_RETURN_FLAG;
import static org.horizon.module.bpm.framework.flowable.core.enums.BpmnVariableConstants.PROCESS_INSTANCE_VARIABLE_SKIP_START_USER_NODE;
import static org.horizon.module.bpm.framework.flowable.core.util.BpmnModelUtils.*;
...
//        }
    ...
    public void rejectTask(Long userId, @Valid BpmTaskRejectReqVO reqVO) {
        ...
        // 疑问：为什么要标记未通过呢？
        // 回答：例如说 A 任务被向前加签除 B 任务时，B 任务被审批不通过，此时 A 会被取消。而 horizon-ui-admin-vue3 不展示“已取消”的任务，导致展示不出审批不通过的细节。
    ...
    public void delegateTask(Long userId, BpmTaskDelegateReqVO reqVO) {
        ...
        // 特殊：如果已经被委派（owner 非空），则不需要更新 owner：https://gitee.com/zhijiantianya/horizon-cloud/issues/ICJ153
    ...
    public void transferTask(Long userId, BpmTaskTransferReqVO reqVO) {
        ...
        // 3.1 设置任务所有人 (owner) 为原任务的处理人 (assignee)
        // 特殊：如果已经被转派（owner 非空），则不需要更新 owner：https://gitee.com/zhijiantianya/horizon-cloud/issues/ICJ153
        if (StrUtil.isEmpty(task.getOwner())) {
            taskService.setOwner(taskId, task.getAssignee());
        }
    ...
    public void processTaskCreated(Task task) {
        ...
        TransactionSynchronizationManager.registerSynchronization(new TransactionSynchronization() {
             ...
             * 参见 <a href="https://gitee.com/zhijiantianya/horizon-cloud/issues/IB7V7Q">issue</a> 反馈
             */
            @Override
