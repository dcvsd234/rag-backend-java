package org.horizon.module.mp.service.account;
...
import org.horizon.module.mp.controller.admin.account.vo.MpAccountCreateReqVO;
import org.horizon.module.mp.controller.admin.account.vo.MpAccountPageReqVO;
import org.horizon.module.mp.controller.admin.account.vo.MpAccountUpdateReqVO;
import org.horizon.module.mp.convert.account.MpAccountConvert;
import org.horizon.module.mp.dal.dataobject.account.MpAccountDO;
import org.horizon.module.mp.dal.mysql.account.MpAccountMapper;
import org.horizon.module.mp.enums.ErrorCodeConstants;
import org.horizon.module.mp.framework.mp.core.MpServiceFactory;
...
import static org.horizon.framework.common.util.collection.CollectionUtils.getMaxValue;
import static org.horizon.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 horizon-module-mp - 表结构未导入][参考 https://doc.iocoder.cn/mp/build/ 开启]");
            }
