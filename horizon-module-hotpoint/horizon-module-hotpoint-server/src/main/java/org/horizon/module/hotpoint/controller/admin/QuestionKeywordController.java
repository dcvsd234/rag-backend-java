...
import org.horizon.module.hotpoint.service.QuestionKeywordService;
...
@RestController
@RequestMapping("/system/hotpoint")
@Validated
public class QuestionKeywordController {
    ...
    @PreAuthorize("@ss.hasPermission('hotpoint:question-keyword:create')")
