package org.horizon.module.ai.framework.ai.core;
...
import org.horizon.framework.common.util.spring.SpringUtils;
import org.horizon.module.ai.enums.model.AiPlatformEnum;
import org.horizon.module.ai.framework.ai.config.AiAutoConfiguration;
import org.horizon.module.ai.framework.ai.config.HorizonAiProperties;
...
import org.horizon.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import org.horizon.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            HorizonAiProperties.MidjourneyProperties properties = SpringUtil.getBean(HorizonAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(HorizonAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        HorizonAiProperties.DouBaoProperties properties = new HorizonAiProperties.DouBaoProperties()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(HorizonAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        HorizonAiProperties.HunYuanProperties properties = new HorizonAiProperties.HunYuanProperties()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(HorizonAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        HorizonAiProperties.SiliconFlowProperties properties = new HorizonAiProperties.SiliconFlowProperties()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(HorizonAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        HorizonAiProperties.XingHuoProperties properties = new HorizonAiProperties.XingHuoProperties()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(HorizonAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        HorizonAiProperties.BaiChuanProperties properties = new HorizonAiProperties.BaiChuanProperties()
                .setApiKey(apiKey);
