...
@SpringBootApplication(scanBasePackages = {"${horizon.info.base-package}.server", "${horizon.info.base-package}.module", "org.horizon.framework.ai", "org.horizon.module.knowledge", "org.horizon.module.trends"},
        excludeName = {
            // RPC 相关
