...
@SpringBootApplication(scanBasePackages = {"${horizon.info.base-package}.server", "${horizon.info.base-package}.module", "org.horizon.framework.ai", "org.horizon.module.dataset"},
        excludeName = {
            // RPC 相关
