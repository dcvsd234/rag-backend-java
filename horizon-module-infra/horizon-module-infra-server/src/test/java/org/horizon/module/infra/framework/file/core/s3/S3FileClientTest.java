package org.horizon.module.infra.framework.file.core.s3;
...
public class S3FileClientTest {
    ...
    public void testMinIO() throws Exception {
        ...
        config.setBucket("horizonyuanma");
...
//        config.setAccessSecret(System.getenv("QINIU_SECRET_KEY"));
        ...
        config.setDomain("http://test.horizon.iocoder.cn"); // 如果有自定义域名，则可以设置。http://static.horizon.iocoder.cn
        // 默认上海的 endpoint
