package org.horizon.module.infra.service.logger;
...
import org.horizon.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import org.horizon.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import org.horizon.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import org.horizon.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static org.horizon.framework.common.util.date.LocalDateTimeUtils.*;
...
import static org.horizon.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static org.horizon.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("horizon-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("horizon-test");
