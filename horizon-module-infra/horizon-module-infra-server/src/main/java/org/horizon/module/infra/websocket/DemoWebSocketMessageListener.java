package org.horizon.module.infra.websocket;
...
import org.horizon.framework.websocket.core.sender.WebSocketMessageSender;
import org.horizon.framework.websocket.core.util.WebSocketFrameworkUtils;
import org.horizon.module.infra.websocket.message.DemoReceiveMessage;
import org.horizon.module.infra.websocket.message.DemoSendMessage;
...
public class DemoWebSocketMessageListener implements WebSocketMessageListener<DemoSendMessage> {
    ...
    @Autowired(required = false) // 由于 horizon.websocket.enable 配置项，可以关闭 WebSocket 的功能，所以这里只能不强制注入
