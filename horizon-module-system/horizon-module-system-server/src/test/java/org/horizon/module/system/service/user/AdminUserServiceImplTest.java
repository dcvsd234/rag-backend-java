package org.horizon.module.system.service.user;
...
import org.horizon.framework.common.util.collection.ArrayUtils;
...
import org.horizon.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import org.horizon.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import org.horizon.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import org.horizon.module.system.controller.admin.user.vo.user.UserImportRespVO;
import org.horizon.module.system.controller.admin.user.vo.user.UserPageReqVO;
import org.horizon.module.system.controller.admin.user.vo.user.UserSaveReqVO;
import org.horizon.module.system.dal.dataobject.dept.DeptDO;
import org.horizon.module.system.dal.dataobject.dept.PostDO;
import org.horizon.module.system.dal.dataobject.dept.UserPostDO;
...
import org.horizon.module.system.dal.mysql.dept.UserPostMapper;
import org.horizon.module.system.dal.mysql.user.AdminUserMapper;
import org.horizon.module.system.enums.common.SexEnum;
import org.horizon.module.system.service.dept.DeptService;
import org.horizon.module.system.service.dept.PostService;
import org.horizon.module.system.service.permission.PermissionService;
import org.horizon.module.system.service.tenant.TenantService;
...
import static org.horizon.framework.common.util.collection.SetUtils.asSet;
import static org.horizon.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static org.horizon.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static org.horizon.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static org.horizon.framework.test.core.util.AssertUtils.assertPojoEquals;
...
import static org.horizon.module.system.enums.ErrorCodeConstants.*;
import static org.horizon.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn(success("horizonyuanma"));
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("horizonyuanma");
        ...
        assertEquals("horizonyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("horizonyuanma"))).thenReturn("java");
