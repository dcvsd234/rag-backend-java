package org.horizon.framework.desensitize.core;

import org.horizon.framework.common.util.json.JsonUtils;
import org.horizon.framework.desensitize.core.regex.annotation.EmailDesensitize;
import org.horizon.framework.desensitize.core.regex.annotation.RegexDesensitize;
import org.horizon.framework.desensitize.core.annotation.Address;
import org.horizon.framework.desensitize.core.slider.annotation.BankCardDesensitize;
import org.horizon.framework.desensitize.core.slider.annotation.CarLicenseDesensitize;
import org.horizon.framework.desensitize.core.slider.annotation.ChineseNameDesensitize;
import org.horizon.framework.desensitize.core.slider.annotation.FixedPhoneDesensitize;
import org.horizon.framework.desensitize.core.slider.annotation.IdCardDesensitize;
import org.horizon.framework.desensitize.core.slider.annotation.PasswordDesensitize;
import org.horizon.framework.desensitize.core.slider.annotation.MobileDesensitize;
import org.horizon.framework.desensitize.core.slider.annotation.SliderDesensitize;
import lombok.Data;
