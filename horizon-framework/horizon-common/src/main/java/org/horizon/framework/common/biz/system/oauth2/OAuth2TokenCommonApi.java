package org.horizon.framework.common.biz.system.oauth2;

import org.horizon.framework.common.enums.RpcConstants;
...
public interface OAuth2TokenCommonApi {
    ...
    @Parameters({
        ...
        @Parameter(name = "clientId", description = "客户端编号", required = true, example = "horizonyuanma")
    })
