 ...
 *      1）Spring Async：
 *          {@link org.horizon.framework.quartz.config.HorizonAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 HorizonSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package org.horizon.framework.tenant;
